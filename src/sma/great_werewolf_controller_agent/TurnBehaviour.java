...
public class TurnBehaviour extends SimpleBehaviour {
	...
	private GreatWerewolfControllerAgent ctrlAgent;
	private int nbPlayers;
	private AID aidVictim;

	public TurnBehaviour(GreatWerewolfControllerAgent GreatWerewolfControllerAgent) {
		super(GreatWerewolfControllerAgent);

		this.ctrlAgent = GreatWerewolfControllerAgent;
	...
	public void action() {
		...
		{
			String[] args ={Status.SLEEP, Roles.GREAT_WEREWOLF};
		...
		else if(this.step.equals(STATE_SEND_VOTE_REQUEST))
		{
			...
			request.setRequest("GREAT_WEREWOLF_VOTE");
