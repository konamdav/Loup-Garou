 ...
 *
 */
public class FamilyControllerAgent extends Agent implements IController {
	private int gameid;
	
	public FamilyControllerAgent() {
		super();	
	}
	...
	protected void setup() {
		...
		DFServices.registerGameControllerAgent(Roles.FAMILY, this, this.gameid);		
