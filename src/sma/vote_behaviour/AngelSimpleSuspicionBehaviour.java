 ...
 *
 */
public class AngelSimpleSuspicionBehaviour extends Behaviour {
	...
	public AngelSimpleSuspicionBehaviour(PlayerAgent playerAgent) {
		super();
		this.playerAgent = playerAgent;
		this.name_behaviour = "ANGEL_SIMPLE_SUSPICION";
	...
	{
		int score = 0;
		if(!player.getName().equals(this.playerAgent.getAID().getName()))
		{
