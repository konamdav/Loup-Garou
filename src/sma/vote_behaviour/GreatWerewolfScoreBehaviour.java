 ...
 *
 */
public class GreatWerewolfScoreBehaviour extends Behaviour implements IVoteBehaviour {
	...
	public GreatWerewolfScoreBehaviour(PlayerAgent playerAgent) {
		super();
		this.playerAgent = playerAgent;
		this.name_behaviour = "GREAT_WEREWOLF_SCORE";
