...
public class TurnBehaviour extends SimpleBehaviour {
	...
	private final static String STATE_SEND_WAKE_LITTLE_GIRL = "SEND_WAKE_LITTLE_GIRL";
	private final static String STATE_RECEIVE_WAKE_LITTLE_GIRL= "RECEIVE_WAKE_LITTLE_GIRL";

	private final static String STATE_SEND_SLEEP_LITTLE_GIRL = "SEND_SLEEP_LITTLE_GIRL";
	private final static String STATE_RECEIVE_SLEEP_LITTLE_GIRL= "RECEIVE_SLEEP_LITTLE_GIRL";

	private final static String STATE_MOVE_WEREWOLF = "MOVE_WEREWOLF";
	private final static String STATE_MOVE_LITTLE_GIRL = "MOVE_LITTLE_GIRL";
	private final static String STATE_INFORM_LITTLE_GIRL = "INFORM_LITTLE_GIRL";
