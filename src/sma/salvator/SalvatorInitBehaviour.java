...
import sma.hunter_behaviour.HunterDeathBehaviour;
...
public class SalvatorInitBehaviour extends OneShotBehaviour {
	private PlayerAgent agent;
	private AID receiver;

	public SalvatorInitBehaviour(PlayerAgent agent, AID receiver) {
		super();
		this.agent = agent;
